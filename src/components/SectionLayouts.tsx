  ...
  const data = [
    {
      ...
      link: "https://wromox.wromo.com.com/category/mobile/",
    },
    {
      img: authorImg,
      text: "Author page",
      subText: "Author page",
      link: "https://wromox.wromo.com.com/author/jaren-nader/",
    },
    {
      img: searchImg,
      text: "Search page",
      subText: "Search page",
      link: "https://wromox.wromo.com.com/?s=Minima",
    },
    {
      img: singleAudioImg,
      text: "Single Audio",
      subText: "Single format Audio",
      link: "https://wromox.wromo.com.com/velit-at-dolorem-dignissimos/",
    },
    {
      img: submitPostImg,
      text: "Submission post page",
      subText: "Need login - (guest/guest)",
      link: "https://wromox.wromo.com.com/ncmaz-submission-post-editor/?action=create",
      tag: "HOT!",
    },
    {
      img: editAccountImg,
      ...
      subText: "Need login - (guest/guest)",
      link: "https://wromox.wromo.com.com/ncmaz-account/?tab=general",
      tag: "HOT!",
    },
    {
      img: single3Img,
      ...
      link: "https://wromox.wromo.com.com/sint-est-autem-quibusdam-asperiores-occaecati-voluptatem/",
    },
    {
      img: singleVideoImg,
      text: "Single Video",
      subText: "Single format Video",
      link: "https://wromox.wromo.com.com/aspernatur-deserunt-repudiandae-provident-assumenda-odit-voluptas/",
    },

    {
      ...
      link: "https://wromox.wromo.com.com/hello-world/",
    },
  ];
