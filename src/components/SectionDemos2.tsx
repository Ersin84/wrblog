...
export const SectionDemos = () => {
  const data = [
    ...
    },
    {
      ...
      text: "Home style 2",
      subText: "Home Default",
      link: "https://wromox.wromo.com/home-2/",
    },
    {
      img: home3,
      text: "Home - Podcast/Music",
      subText: "Home Default",
      link: "https://wromox.wromo.com/home-3/",
    },
    {
      img: home4,
      text: "Home - Video",
      subText: "Home Default",
      link: "https://wromox.wromo.com/home-4/",
      tags: ["new!"],
    },
    {
      img: home5,
      text: "Home - Gallery",
      subText: "Home Default",
      link: "https://wromox.wromo.com/home-5/",
      tags: ["new!"],
    },
    {
      img: home6,
      text: "Home style 6",
      subText: "Home Default",
      link: "https://wromox.wromo.com/home-6/",
      tags: ["new!"],
    },
    {
      img: homeRTL,
